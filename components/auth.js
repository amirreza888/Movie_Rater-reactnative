...
import { StyleSheet, FlatList, View ,Text, Image, Button,TextInput,AsyncStorage,TouchableOpacity } from 'react-native';
...
export default function Auth(props) {
    ...
    const auth = ()=>{
        if (regView) {
            fetch(`http://192.168.43.219:8000/api/users/`, {
            method: 'POST',
            headers: {
            ...
            fetch(`http://192.168.43.219:8000/auth/`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
